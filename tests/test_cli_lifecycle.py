...
LIFECYCLE_COMMANDS = cli_module.LIFECYCLE_COMMANDS
cmd_lifecycle = cli_module.cmd_lifecycle
...
class TestCLIIntegration:
    ...
    def test_main_help_includes_lifecycle_commands(self):
        with pytest.raises(SystemExit) as exc_info, patch("sys.stdout", new=StringIO()) as fake_out:
            main()
