...
class TestQuickBonusLifecycle:
    ...
    def test_factory_shortcut_default(self):
        from scripts.collaboration.lifecycle_protocol import create_lifecycle_protocol
    ...
    def test_factory_full_explicit(self):
        from scripts.collaboration.lifecycle_protocol import LifecycleMode, create_lifecycle_protocol
