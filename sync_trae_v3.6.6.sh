#!/bin/bash
# TRAE 环境完整同步脚本 - DevSquad V3.6.6 (修复版)
# 
# ⚠️ 重要：TRAE 优先使用 L3 项目级缓存 (.trae/skills/)
#    而不是 L2 用户级缓存 (~/.trae/skills/)
#
# 用法: bash sync_trae_v3.6.6_fixed.sh

set -e

echo "╔══════════════════════════════════════════════════════════╗"
echo "║  DevSquad V3.6.6 - TRAE Complete Sync (L2 + L3)       ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "3. 打开 Skills 面板，确认 devsquad 显示 V3.6.6"
echo ""
echo "4. 测试技能功能:"
