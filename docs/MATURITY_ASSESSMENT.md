...
> V3.6.7 评估为 65%。V3.8.0 通过新增 Two-Stage Review Gate、Severity Router、Judge Agent、Micro-Task Planner、Content Cache 等模块，以及 226 个新测试，将综合得分提升至 72%。
...
| 新增模块 | 测试数 | 成熟度贡献 | 说明 |
|---------|--------|-----------|------|
| TwoStageReviewGate | 40 | +2% | 规范合规 + 代码质量两阶段审查，关键发现阻断 |
