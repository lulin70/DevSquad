...
| CI gate | `check_module_activation.py --window 7d` | exits 0 (VC-11) |
| Test pyramid | Contract ≥5%, Integration ≥15% | VC-12 green |
| Zero regression | Existing 8165+ tests | VC-5 green |
| Version sync | 38/38 consistency | VC-10 green |
...
| DevOps | CI green; `check_module_activation.py` passes; Dashboard renders |
...
> **Document Status**: Approved — Ready for V4.3.3 (M0) execution
> **Next Step**: M0 — commit the 4 landing-plan documents + 13 xfail skeletons → tag `v4.3.3` → begin M1 (P0-1 Risk Register)
