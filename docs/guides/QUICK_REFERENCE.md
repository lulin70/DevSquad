# DevSquad 快速参考 (V3.6.0)

> ⚠️ **已过时 (HISTORICAL)** — 本文档停留在 V3.6.0 (2026-05-13)，当前版本为 V4.0.11。
> 最新命令参考请参阅: [README.md](../../README.md) + [SKILL.md](../../SKILL.md)

> **版本**: V3.6.0 — **历史版本** | **最后更新**: 2026-05-13
>
