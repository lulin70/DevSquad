...
version: 4.6.1
description: |
  DevSquad V4.6.1 — Multi-Role AI Orchestration Skill.
  ...
  V4.6.1 — Skill registration gate (check_version_consistency blocks on SKILL.md frontmatter YAML parseability — the true "/" panel root cause) + Prometheus end-to-end scrape verification (scripts/verify_prometheus_e2e.py, honest pass|fail|tool_missing) + skill pack synced to all 3 TRAE cache levels (L1 ~/.trae-cn, L2 ~/.trae, L3 workspace .trae — user decision 2026-09-02, supersedes V4.5.13 single-source).
...
# DevSquad V4.6.1 — Multi-Role AI Task Orchestrator
...
| [docs/reference/VERSION_HISTORY.md](docs/reference/VERSION_HISTORY.md) | Version history + per-version changelog (v1.0 → v4.6.1) | Release tracking / auditors |
