...
version: 4.1.6
description: |
  V4.1.6 DevSquad — Enterprise Multi-Role AI Task Orchestrator.
...
# DevSquad V4.1.6 — Multi-Role AI Task Orchestrator (Enterprise-Ready: Core production-ready; RBAC/Audit/Multi-Tenancy in Preview)
