...
version: 4.1.3
description: |
  V4.1.3 DevSquad — Enterprise Multi-Role AI Task Orchestrator.
...
# DevSquad V4.1.3 — Multi-Role AI Task Orchestrator (Enterprise-Ready: Core production-ready; RBAC/Audit/Multi-Tenancy in Preview)
