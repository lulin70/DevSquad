...
version: 4.3.0
description: |
  DevSquad V4.3.0 — Multi-Role AI Orchestration Skill.
  ...
  155+ core modules, 9320+ tests passing (CI authoritative).
  ...
  V4.3.0: DependencyHallucinationChecker (anti-Slopsquatting) + OutputValidator full integration + Phase 3 quality hardening (red-team/audit-markdown/FiveAxis-heuristic/user-simulation E2E).
---

# DevSquad V4.3.0 — Multi-Role AI Task Orchestrator
