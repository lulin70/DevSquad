...
> **Version discipline (user ruling, 2026-09-24)**: the minor version is frozen — no MINOR bump may be applied without the maintainer's explicit approval. This section therefore targets a `4.5.x` PATCH release; whether to cut a PATCH tag inside the `4.5` line is still undecided. See `docs/prd/V4.5.20_CONSENSUS_RECORD.md` (round 9).
