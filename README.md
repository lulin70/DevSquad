...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/V4.0.2-success" />
...
```bash
python3 scripts/cli.py --version       # Expected: DevSquad 4.0.2
...
*Last updated: 2026-07-11 | Version: V4.0.2*
