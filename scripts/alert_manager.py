...
class AlertManager:
    ...
    def __init__(self, config_path: str | None = None):
        ...
        """
        self.config_path = config_path or os.path.join(os.path.dirname(__file__), "..", "config", "alerts.yaml")
...
"""
    ...
    def get_alert_history(self, severity: AlertSeverity | None = None, hours: int = 24, limit: int = 50) -> list[dict]:
        """
        Get alert history.
        ...
        filtered = [
            ...
            if alert.timestamp >= cutoff and (severity is None or alert.severity == severity)
        ]
    ...
    def get_alert_stats(self, hours: int = 24) -> dict[str, Any]:
        ...
        stats = {"total": len(recent_alerts), "by_severity": {}, "by_source": {}, "period_hours": hours}
