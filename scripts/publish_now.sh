...
- **Version Consistency**: Unified V3.6.6 across all 27 documentation files
...
curl -s -X PATCH \
  ...
  -d '{
    "name": "DevSquad",
    "description": "🚀 DevSquad V3.6.6 - Enterprise Multi-Role AI Task Orchestrator | Documentation Experience | E2E Testing | 7-Agent Collaboration | RBAC | PyPI Ready",
