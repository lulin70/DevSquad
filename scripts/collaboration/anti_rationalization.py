...
class AntiRationalizationEngine:
    ...
    _ROLE_SPECIFIC_TABLES: dict[str, list[RationalizationRow]] = {
        "architect": [
            ...
            RationalizationRow(
                ...
                reality=("Design for the next 2x scale, not just today's load. Future-you will thank present-you"),
            ),
            RationalizationRow(
                excuse="This pattern is standard in the industry",
                reality=("Standard doesn't mean optimal. Evaluate if this pattern fits our specific constraints"),
            ),
            RationalizationRow(
                excuse="Adding abstraction improves flexibility",
                reality=("Every abstraction adds complexity. Don't generalize until the third use case demands it"),
            ),
        ],
        "product-manager": [
            RationalizationRow(
            ...
            RationalizationRow(
                ...
                reality=("Iteration without a baseline wastes effort. Establish the baseline first"),
            ),
            RationalizationRow(
                excuse="Edge cases can be handled later",
                reality=("Edge cases are where production systems fail. Define them in acceptance criteria"),
            ),
            RationalizationRow(
                excuse="The competitor does it this way",
                reality=("Competitor decisions reflect their constraints, not ours. Evaluate independently"),
            ),
        ],
        "security": [
            RationalizationRow(
            ...
            RationalizationRow(
                ...
                reality=(
                    "Auth is the foundation of security. Define auth requirements even if implementation is deferred"
                ),
            ),
        ],
        "tester": [
        ...
        "devops": [
            ...
            RationalizationRow(
                ...
                reality=("Flaky tests mask real bugs and waste everyone's time. Fix the flakiness"),
            ),
            RationalizationRow(
                excuse="Manual testing is enough",
                reality=("Manual testing doesn't scale and isn't repeatable. Automate what you can"),
            ),
        ],
        "ui-designer": [
            RationalizationRow(
                ...
                reality=(
                    "Test on real devices, screen readers, and slow networks. 'Fine on my screen' excludes most users"
                ),
            ),
            RationalizationRow(
            ...
            RationalizationRow(
                ...
                reality=("Mockups don't show edge cases, error states, or loading scenarios. Design for all states"),
            ),
            RationalizationRow(
    ...
    def total_entries(self) -> int:
        ...
        max_specific = max(len(v) for v in self._ROLE_SPECIFIC_TABLES.values()) if self._ROLE_SPECIFIC_TABLES else 0
