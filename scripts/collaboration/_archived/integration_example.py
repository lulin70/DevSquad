...
from scripts.collaboration.llm_retry import get_retry_manager, retry_with_fallback
from scripts.collaboration.performance_monitor import get_monitor, monitor_performance
...
@retry_with_fallback(max_retries=3, initial_delay=1.0, fallback_backends=["openai", "anthropic", "zhipu"])
def optimized_llm_call(prompt: str, backend: str = "openai", model: str = "gpt-4") -> str:
    """
    优化的 LLM 调用函数
