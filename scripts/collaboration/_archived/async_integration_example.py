...
async def example_retry_fallback():
    ...
    @async_retry_with_fallback(max_retries=3, initial_delay=0.1, fallback_backends=["anthropic"])
...
async def example_combined():
    ...
    @async_retry_with_fallback(max_retries=2, initial_delay=0.1, fallback_backends=["anthropic"])
...
async def example_circuit_breaker():
    ...
    @async_retry_with_fallback(max_retries=1, initial_delay=0.05, fallback_backends=["anthropic"])
