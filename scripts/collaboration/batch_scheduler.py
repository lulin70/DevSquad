...
class BatchScheduler:
    ...
    def schedule(self, batches: list[TaskBatch], workers: dict) -> ScheduleResult:
        """
        执行批处理调度计划
    ...
    def _execute_parallel(self, batch: TaskBatch, workers: dict) -> tuple:
        results = []
        errors = []
    ...
    def _execute_serial(self, batch: TaskBatch, workers: dict) -> tuple:
        results = []
        errors = []
