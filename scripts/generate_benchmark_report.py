...
<head>
    ...
    <title>DevSquad Benchmark Report - V3.6.7</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>V3.6.7 | Plan C Layered Architecture | Generated: {now}</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tr>
                        <td>Version</td>
                        <td><code>V3.6.7</code> (Plan C Layered Architecture)</td>
                    </tr>
                    <tr>
                        <td>Python</td>
        ...
        <div class="footer">
            ...
            <p>Version V3.6.7 | Plan C Layered Architecture | © 2026 DevSquad Team</p>
        </div>
    </div>
</body>
</html>"""
