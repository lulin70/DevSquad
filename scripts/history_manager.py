...
class HistoryManager:
    ...
    def get_api_stats(self, hours: int = 1, group_by_path: bool = True) -> dict[str, Any]:
        ...
        try:
            ...
            stats["status_codes"] = [
                {"status_code": row["status_code"], "count": row["count"]} for row in cursor.fetchall()
            ]
        ...
        try:
            ...
            cursor.execute(
                ...
                INSERT INTO lifecycle_events (
                    timestamp, event_type, phase_id, previous_status,
    ...
    def get_lifecycle_history(
        self, hours: int = 24, phase_id: str | None = None, event_type: str | None = None
    ) -> list[dict[str, Any]]:
        """
