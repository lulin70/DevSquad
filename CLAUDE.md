...
**DevSquad** is a **V3.6.8 Enterprise Multi-Role AI Task Orchestrator**. It transforms a single AI task into multi-role AI collaboration with 7 core roles. Based on the Coordinator/Worker/Scratchpad pattern with ThreadPoolExecutor parallel execution.
...
**Test Coverage**: 1940+ tests all passing (100% unit + 100% E2E).
...
## Architecture (V3.6.8 Enterprise Three-Layer)
...
python3 scripts/cli.py --version  # 3.6.8
```
...
│   │   ├── _version.py         # Version SSOT (3.6.8)
...
- **Testing**: pytest-based, 1940+ tests all passing
- **Style**: PEP 8, dataclasses for models, type hints throughout
- **Version**: Single source of truth in `_version.py` (`3.6.8`)
