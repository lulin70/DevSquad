...
**DevSquad** is a **V3.9.3 Enterprise Multi-Role AI Task Orchestrator**. It transforms a single AI task into multi-role AI collaboration with 7 core roles. Based on the Coordinator/Worker/Scratchpad pattern with ThreadPoolExecutor parallel execution.
...
## Architecture (V3.9.3 Enterprise Three-Layer)
...
python3 scripts/cli.py --version  # 3.9.3
```
...
│   │   ├── _version.py         # Version SSOT (3.9.3)
