...
**Test Coverage**: 2857+ tests passing across unit + E2E + integration suites (CI authoritative, Python 3.10+3.11 matrix; 18 skipped integration tests require real LLM API key).
...
## Architecture (V4.0.11 Enterprise Three-Layer)
...
python3 scripts/cli.py --version  # 4.0.0
```
...
│   │   ├── _version.py         # Version SSOT (4.0.0)
